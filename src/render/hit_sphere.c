...
/*   Updated: 2022/10/24 15:47:37 by kanykei          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/render.h"

static bool hit_point(t_objlst *objects, t_ray *ray, t_record *record, double root)
{
    t_sphere    *sphere;
    ...
    unit_vector(&record->normal, subtraction(&record->normal, &record->point, &sphere->center));
